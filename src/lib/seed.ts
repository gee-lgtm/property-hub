  ...
  const properties = await Promise.all([
    prisma.property.create({
      data: {
        ...
        address: 'Sukhbaatar District, Apartment 15',
        city: 'Ulaanbaatar',
        state: 'Ulaanbaatar',
        zipCode: '14200',
        latitude: 47.9184,
    ...
    prisma.property.create({
      data: {
        ...
        address: 'Khan-Uul District, House 25',
        city: 'Ulaanbaatar',
        state: 'Ulaanbaatar',
        zipCode: '17042',
        latitude: 47.8864,
    ...
    prisma.property.create({
      data: {
        ...
        address: 'Bayangol District, Tower 12',
        city: 'Ulaanbaatar',
        state: 'Ulaanbaatar',
        zipCode: '16040',
        latitude: 47.9073,
    ...
    prisma.property.create({
      data: {
        ...
        address: 'Chingeltei District, Apartment 8',
        city: 'Ulaanbaatar',
        state: 'Ulaanbaatar',
        zipCode: '15160',
        latitude: 47.9351,
    ...
    prisma.property.create({
      data: {
        ...
        address: 'Songino Khairkhan District, Building 3',
        city: 'Ulaanbaatar',
        state: 'Ulaanbaatar',
        zipCode: '18040',
        latitude: 47.8516,
